...
export default function SignUpPage() {
  ...
  return (
    <main className="relative min-h-screen text-gray-100 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-[var(--dnd-text-muted)] mb-8 text-sm">Start scheduling your D&amp;D sessions.</p>
      ...
      <p className="mt-6 text-sm text-[var(--dnd-text-muted)]">
        ...
        <Link href="/auth/login" className="text-[var(--dnd-accent)] hover:text-[var(--dnd-accent-hover)] underline">Log in</Link>
      </p>
    </main>
  )
}
